...
The next pretrained-representation question, smallest MVP, remote-compute
preflight, and stopping rules are frozen in
[`docs/L2_EXPERIMENT_SPEC.md`](docs/L2_EXPERIMENT_SPEC.md).
